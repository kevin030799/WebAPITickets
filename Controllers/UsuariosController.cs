...
namespace WebAPITickets.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuario>> ValidarIngreso([FromQuery] string correo, [FromQuery] string clave)
        {
        ...
        {
            return _context.Usuarios.Any(e => e.us_identificador == id);
        }
    }
}
